...
|--------|-------------|---------|
| A: user_id | Unique user identifier | U001 |
| B: telegram_chat_id | Telegram chat ID for sending messages (blank until user connects) | 123456789 |
| C: name | Contact name | Rahul Sharma |
| D: email | User's email (used for matching in Zap #2 and sending invites in Zap #1) | rahul@example.com |
| E: business_name | Their business | TechStart Solutions |
| F: business_type | Proprietorship/Pvt Ltd/etc. | Proprietorship |
| G: current_stage | Stage number (1-7) | 3 |
| H: stage_name | Human readable stage | KYC Verification |
| I: last_activity | Timestamp of last action | 2026-02-18T10:30:00 |
| J: nudge_count | Number of nudges sent | 1 |
| K: last_nudge_sent | Timestamp of last nudge | 2026-02-19T10:30:00 |
| L: status | active / completed / opted_out | active |
| M: invite_sent | Whether bot invite email has been sent (yes/no) | no |
| N: drop_off_reason | Why they dropped (from bot conversation) | Documents not ready |
| O: notes | Additional context | Will return after GST registration |
...
ACTION 2: Filter by Zapier
  - Condition: telegram_chat_id exists (not empty — user is connected)
  - AND last_activity is before 24 hours ago
  - AND nudge_count < 4
...
ACTION 2: ChatGPT (OpenAI) - Conversation
  ...
  - System Prompt:
    "You are a helpful Razorpay onboarding assistant on Telegram.
     ...
     Their last activity was on {last_activity}.
...
#### Step 5: Zap 3 - Email Invite (sends bot link to new users)
...
ACTION 2: Filter by Zapier
  - Condition: telegram_chat_id does not exist (blank — not connected)
  - AND status = "active"
  - AND invite_sent = "no"

ACTION 3: Gmail / Email by Zapier - Send Email
  - To: {email}
  - Subject: "Need help finishing your Razorpay setup?"
  - Body: Personalized email with bot link using {name},
          {business_name}, {stage_name} fields
...
|---------|-----------------|------|-------|---------------|---------------|---------------|------------|--------------|-------------|----------------|--------|-------------|-----------------|-------|
| U001 | 111222333 | Priya Mehta | priya.mehta@gmail.com | CraftBazaar | Proprietorship | 3 | KYC Verification | 2026-02-17T14:00:00 | 0 | | active | yes | | |
| U002 | 444555666 | Arjun Patel | arjun@devstack.io | DevStack Solutions | Pvt Ltd | 5 | Website Details | 2026-02-16T09:30:00 | 1 | 2026-02-17T10:00:00 | active | yes | | |
| U003 | 777888999 | Sneha Gupta | sneha.fitlife@gmail.com | FitLife Studio | Proprietorship | 6 | Integration | 2026-02-18T16:00:00 | 0 | | active | yes | | |
| U004 | 101112131 | Rajesh Kumar | rajesh@kisandirect.com | KisanDirect | Partnership | 2 | Business Profile | 2026-02-15T11:00:00 | 2 | 2026-02-17T11:00:00 | active | yes | | |
