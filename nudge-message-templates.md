...
Copy-paste these into your Zapier Path actions. Replace `{{variables}}` with Zapier field mappings.
...
You completed {{current_stage}} of 7 steps. Just {{7 - current_stage}} more to go!
